...
public final class OracleConnectionParametersPanel extends JdbcConnectionParametersPanel<OraclePersister> {
	...
	public OracleConnectionParametersPanel(final OracleConnectionParameters connectionParameters) {
		...
		final GridBagConstraints gbc_lblSid = new GridBagConstraints();
		gbc_lblSid.insets = new Insets(0, 0, 5, 5);
		gbc_lblSid.anchor = GridBagConstraints.WEST;
		gbc_lblSid.gridx = 0;
		gbc_lblSid.gridy = 0;
		panel.add(lblSid, gbc_lblSid);

		final JTextField textFieldSid = new JTextField();
		lblSid.setLabelFor(textFieldSid);
		textFieldSid.setEditable(false);
		textFieldSid.setText(connectionParameters.getSid());
		final GridBagConstraints gbc_textFieldSid = new GridBagConstraints();
		gbc_textFieldSid.weightx = 1.0;
		gbc_textFieldSid.insets = new Insets(0, 0, 5, 0);
		gbc_textFieldSid.fill = GridBagConstraints.HORIZONTAL;
		gbc_textFieldSid.gridx = 1;
		gbc_textFieldSid.gridy = 0;
		panel.add(textFieldSid, gbc_textFieldSid);
